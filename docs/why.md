...
`go-ruby-sqlite3/sqlite3` reimplements Ruby's `sqlite3` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-sqlite3/sqlite3` directly, with no Ruby runtime;
