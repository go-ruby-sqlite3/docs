...
The public API lives at the module root (`github.com/go-ruby-sqlite3/sqlite3`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `sqlite3`, while the surface follows
...
```go
import "github.com/go-ruby-sqlite3/sqlite3"
```
...
- **[pkg.go.dev/github.com/go-ruby-sqlite3/sqlite3](https://pkg.go.dev/github.com/go-ruby-sqlite3/sqlite3)**

The module's [README](https://github.com/go-ruby-sqlite3/sqlite3#readme) carries worked
